...
{
    public class AttractorTriangleGravityOverride : AttractorTriangle
    {
        ...
        {
            bool canApplyGravity = _movableCapsule.Capsule.GetClosestPointIfWeCan(graviton.Position, GravityOverride, out closestPoint);
