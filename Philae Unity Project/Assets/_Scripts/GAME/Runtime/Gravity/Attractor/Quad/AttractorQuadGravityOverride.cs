...
{
    public class AttractorQuadGravityOverride : AttractorQuad
    {
        ...
        {
            bool canApplyGravity = _movableQuad.Quad.GetClosestPointIfWeCan(graviton.Position, GravityOverride, out closestPoint);
