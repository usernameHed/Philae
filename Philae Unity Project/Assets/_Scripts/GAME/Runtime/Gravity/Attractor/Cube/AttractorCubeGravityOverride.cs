...
{
    public class AttractorCubeGravityOverride : AttractorCube
    {
        ...
        {
            bool canApplyGravity = _movableCube.Cube.GetClosestPointIfWeCan(graviton.Position, GravityOverride, out closestPoint);
