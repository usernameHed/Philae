...
{
    public class AttractorConeSphereBaseOverride : AttractorCone
    {
        ...
        {
            bool canApplyGravity = _movableCone.Cone.GetClosestPointIfWeCan(graviton.Position, GravityOverride, out closestPoint);
