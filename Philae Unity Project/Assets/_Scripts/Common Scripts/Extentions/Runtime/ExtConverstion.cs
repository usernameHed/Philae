...
namespace hedCommon.extension.runtime
{
    ...
    public static class ExtConverstion
    {
        ...
        /// <summary>
        /// convert a double array into an float array
        /// </summary>
        /// <param name="arrayDouble"></param>
        /// <returns></returns>
        public static float[] ConvertDoubleIntoFloat(double[] arrayDouble)
        {
            if (arrayDouble == null)
            {
                return (null);
        ...
        public static double[] ConvertFloatIntoDouble(float[] arrayFloat)
        {
            if (arrayFloat == null)
            {
                return (null);
