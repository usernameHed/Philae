...
namespace hedCommon.extension.runtime
{
    public static class ExtArray
    {
        ...
        public static bool IsValideIndex<T>(this T[] collection, int index)
        {
        ...
        public static T[] Append<T>(T[] collection, T[] otherToApend)
        {
            ...
            if (collection != null)
            {
                firstLenght = collection.Length;
                totalLenght += firstLenght;
            }
            if (otherToApend != null)
            {
                totalLenght += otherToApend.Length;
            }

            T[] newArray = new T[totalLenght];
            if (collection != null)
            {
            ...
            if (otherToApend != null)
            {
                ...
                {
                    newArray[firstLenght + j] = otherToApend[j];
                }
            }
            return (newArray);
        }
        ...
        /// transform a transform[] array to a gameobejct[] array
        /// </summary>
        /// <param name="arrayGameObjects"></param>
        /// <returns></returns>
        public static Transform[] ToTransformsArray(this GameObject[] arrayGameObjects)
        {
            if (arrayGameObjects == null)
            {
                return (null);
            }

            Transform[] transformArray = new Transform[arrayGameObjects.Length];
            for (int i = 0; i < transformArray.Length; i++)
            {
                transformArray[i] = arrayGameObjects[i].transform;
            }
        ...
        /// <param name="collection"></param>
        /// <returns></returns>
        public static bool IsNullOrEmptyOrEmptyContent<T>(this T[] collection)
        {
            if (collection == null)
            {
                return (true);
            ...
            for (int i = 0; i < collection.Length; i++)
            {
                if (EqualityComparer<T>.Default.Equals(collection[i], default(T)))
                {
                    return (true);
                }
            }
        ...
        /// <returns></returns>
        public static T[] RemoveAt<T>(T[] array, int indexToDelete)
        {
