...
namespace hedCommon.extension.runtime
{
    public static class ExtComponent
    {
        ...
        /// <summary>
        /// return true if the component is present in any of the parent / child of a gameObject (including itself)
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="gameObject"></param>
        /// <param name="component"></param>
        /// <returns></returns>
        public static bool IsComponentExistInAnyParentOrChildren<T>(this GameObject gameObject, out T component) where T : Component
        {
            component = null;
            ...
            component = gameObject.GetExtComponentInChildrens<T>(99, false);
            if (component)
            {
                return (true);
            }
            component = gameObject.GetExtComponentInParents<T>(99, false);
            if (component)
            {
                return (true);
            }
