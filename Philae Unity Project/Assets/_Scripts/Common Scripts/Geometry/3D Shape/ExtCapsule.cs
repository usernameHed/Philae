...
namespace hedCommon.geometry.shape3d
{
    ...
    public struct ExtCapsule
    {
        ...
        [SerializeField]
        private bool _isSphereOnTop;
        public bool IsSphereTop { get { return (_isSphereOnTop); } }
        [SerializeField]
        private bool _isSphereBottom;
        public bool IsSphereBottom { get { return (_isSphereBottom); } }
            ...
            bool bottom = true) : this()
        {
            ...
            _isSphereOnTop = top;
            _isSphereBottom = bottom;
            UpdateMatrix();            
        }

        public ExtCapsule(Vector3 p1, Vector3 p2, float radius = 0.25f, bool top = true, bool bottom = true) : this()
        {
        ...
        {
            ExtDrawGuizmos.DebugCapsuleFromInsidePoint(_p1, _p2, color, _realRadius, 0, true, true, IsSphereTop, IsSphereBottom);
        }
        ...
        public void DrawWithExtraSize(Color color, Vector3 extraSize)
        {
            ...
            ExtDrawGuizmos.DebugCapsuleFromInsidePoint(p1, p2, color, _realRadius, 0, true, true, IsSphereTop, IsSphereBottom);
        }
#endif
        ...
        {
            bool isInsideTopSphere = _isSphereOnTop && _topSphere.IsInsideShape(pointToTest);
            if (isInsideTopSphere)
            {
                return (true);
            }
            bool isInsideBottomSphere = _isSphereBottom && _bottomSphere.IsInsideShape(pointToTest);
