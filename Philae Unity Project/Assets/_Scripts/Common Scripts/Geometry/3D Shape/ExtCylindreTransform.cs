...
{
    public class ExtCylindreTransform
    {
        ...
        public ExtCylindreTransform(Transform transform,
            float radius,
            float lenght)
        {
            ...
            _realRadius = _radius * _transform.localScale.Maximum();
            _realSquaredRadius = _realRadius * _realRadius;

            _cubeMatrix = Matrix4x4.TRS(_transform.position, _transform.rotation, _transform.localScale * _radius);
