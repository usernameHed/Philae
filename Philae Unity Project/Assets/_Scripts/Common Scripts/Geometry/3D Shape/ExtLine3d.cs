...
namespace hedCommon.geometry.shape2d
{
    ...
    public struct ExtLine3d
    {
        ...
        public void DrawWithExtraSize(Color color, float offset)
        {
            ...
            ExtDrawGuizmos.DebugSphere(_line.P1, color, EditorOptions.Instance.SizeLinesPoints);
            ExtDrawGuizmos.DebugSphere(_line.P2, color, EditorOptions.Instance.SizeLinesPoints);
