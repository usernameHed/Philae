...
#pragma warning restore 618
        ...
        public CurvySplineSegment[] AddGlobalPosition(params Vector3[] controlPointsGlobalPosition)
        {
            Vector3[] globalPosition = new Vector3[controlPointsGlobalPosition.Length];

            for (int i = 0; i < controlPointsGlobalPosition.Length; i++)
            {
                globalPosition[i] = transform.InverseTransformPoint(controlPointsGlobalPosition[i]);
            }
            return (Add(globalPosition));
        }
        ...
        /// <summary>
        /// get the nearest point from a ray to the spline
        /// </summary>
        /// <param name="ray"></param>
        /// <param name="nearest"></param>
        /// <param name="startSegmentIndex"></param>
        /// <param name="stopSegmentIndex"></param>
        /// <returns></returns>
