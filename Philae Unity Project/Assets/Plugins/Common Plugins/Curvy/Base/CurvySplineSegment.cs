...
#pragma warning restore 618
        ...
        public Vector3 GetTangentFast(float localF)
        {
            ...
            if (idx < 0 || idx >= ApproximationT.Length
                || idx2 < 0 || idx2 >= ApproximationT.Length)
            {
                return (Vector3.zero);
            }
        ...
        #region ### Own function ###
        /// <summary>
        /// Take another Curvy Spline, and copy his bezier values
        /// </summary>
        /// <param name="other"></param>
        public void CopyBezierOption(CurvySplineSegment other)
        {
            AutoHandles = other.AutoHandles;
            m_AutoHandleDistance = other.m_AutoHandleDistance;
            HandleIn = other.HandleIn;
            HandleOut = other.HandleOut;
            m_AutoBakeOrientation = other.m_AutoBakeOrientation;
            Swirl = other.Swirl;
            SwirlTurns = other.SwirlTurns;
            SerializedOrientationAnchor = other.SerializedOrientationAnchor;
        }
        ...
        /// <summary>
        /// is our Bezier Option Different than the one in the parameter
        /// </summary>
        public bool IsDifferentThanThisOne(CurvySplineSegment other)
        {
            return (AutoHandles != other.AutoHandles
                || m_AutoHandleDistance != other.m_AutoHandleDistance
                || HandleIn != other.HandleIn
                || HandleOut != other.HandleOut
                || m_AutoBakeOrientation != other.m_AutoBakeOrientation
                || Swirl != other.Swirl
                || m_SwirlTurns != other.m_SwirlTurns
                || SerializedOrientationAnchor != other.SerializedOrientationAnchor);
        }
        #endregion
    }
